import{j as r}from"./ui-C3Q6Mp4i.js";import{X as n,x as c}from"./app-CGyY262u.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-C8p4Z8_i.js";import{k as p}from"./helpers-Bp_8Xvf-.js";import{A as h}from"./application-logo-xmsebiRw.js";import{C as u}from"./cookie-consent-DHK8CEmf.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
                .bg-primary {
