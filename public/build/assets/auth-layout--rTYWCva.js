<<<<<<<< HEAD:public/build/assets/auth-layout-D1KhFPyo.js
import{j as r}from"./ui-CFOo-GGi.js";import{X as n,x as c}from"./app-tRd1A5BO.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-CqhIiuBZ.js";import{k as p}from"./helpers-uEf_1DI8.js";import{A as h}from"./application-logo-CoXh6gAf.js";import{C as u}from"./cookie-consent-CilPATJ_.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
========
import{j as r}from"./ui-C3Q6Mp4i.js";import{X as n,x as c}from"./app-BGB6VPpy.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-BgJH37hb.js";import{k as p}from"./helpers-CIlhmUMl.js";import{A as h}from"./application-logo-xmsebiRw.js";import{C as u}from"./cookie-consent-C0h5vQv9.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
>>>>>>>> origin/main:public/build/assets/auth-layout--rTYWCva.js
                .bg-primary {
