<<<<<<<< HEAD:public/build/assets/auth-layout-CFFWemLB.js
import{j as r}from"./ui-CFOo-GGi.js";import{X as n,x as c}from"./app-CN9M72l0.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-DlEtdN10.js";import{k as p}from"./helpers-DC6pPxer.js";import{A as h}from"./application-logo-CoXh6gAf.js";import{C as u}from"./cookie-consent-DqgosWJl.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
========
import{j as r}from"./ui-C3Q6Mp4i.js";import{X as n,x as c}from"./app-Cl0KwQHp.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-CLA_bT68.js";import{k as p}from"./helpers-UFMDVSfZ.js";import{A as h}from"./application-logo-xmsebiRw.js";import{C as u}from"./cookie-consent-D3IuEvrz.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
>>>>>>>> origin/main:public/build/assets/auth-layout-2pvxqDZo.js
                .bg-primary {
