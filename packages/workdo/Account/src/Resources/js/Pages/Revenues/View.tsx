    ...
    const getStatusBadge = (status: string) => {
        return (
            <span className={`px-2 py-1 rounded-full text-sm ${
                status === 'posted' ? 'bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300' :
                status === 'approved' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300' :
