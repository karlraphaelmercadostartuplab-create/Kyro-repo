import{j as r}from"./ui-CFOo-GGi.js";import{X as n,x as c}from"./app-DJyT8xCd.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-BDkIFcab.js";import{k as p}from"./helpers-D2L83REe.js";import{A as h}from"./application-logo-CoXh6gAf.js";import{C as u}from"./cookie-consent-B3T-2DkF.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
                .bg-primary {
