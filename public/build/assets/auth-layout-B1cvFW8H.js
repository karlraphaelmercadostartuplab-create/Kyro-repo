<<<<<<<< HEAD:public/build/assets/auth-layout-BT5WKMKd.js
import{j as r}from"./ui-CFOo-GGi.js";import{X as n,x as c}from"./app-Beqd3zmP.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-Cnmx9mzX.js";import{k as p}from"./helpers-CkRsjJIK.js";import{A as h}from"./application-logo-CoXh6gAf.js";import{C as u}from"./cookie-consent-ColBWPgv.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
========
import{j as r}from"./ui-C3Q6Mp4i.js";import{X as n,x as c}from"./app-BTudeMHF.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-COrlPLyu.js";import{k as p}from"./helpers-CqVBxlgM.js";import{A as h}from"./application-logo-xmsebiRw.js";import{C as u}from"./cookie-consent-62CHkRbM.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
>>>>>>>> f01f411003164ae792864d0b5376b4819b3fe63c:public/build/assets/auth-layout-B1cvFW8H.js
                .bg-primary {
