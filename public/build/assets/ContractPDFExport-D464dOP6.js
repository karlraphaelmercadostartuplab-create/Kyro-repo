const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./html2pdf-D3Qcp1wz.js","./ui-C3Q6Mp4i.js","./app-u0p3KFjy.js","./app-CQG9E_-B.css","./app-DNbyodME.css"])))=>i.map(i=>d[i]);
import{_ as g}from"./app-u0p3KFjy.js";import{j as i}from"./ui-C3Q6Mp4i.js";import{B as x}from"./button-B2GjAh0Z.js";import{a as f,b,c as h}from"./tooltip-CAfzs618.js";import{f as v,a as n,h as p}from"./helpers-CK1cfQwu.js";import{u as _}from"./useTranslation-BO7sSgCd.js";import{D as y}from"./download-3juIl6Jh.js";/* empty css            */import"./index-Gicaz2NY.js";import"./index-BMyiKApA.js";import"./utils-B-dksMZM.js";import"./utils-CmeZxMYV.js";import"./index-Ba-K1hA4.js";import"./createLucideIcon-BtuHH1Ff.js";function A({contract:e,variant:s="outline",size:a="sm"}){const{t}=_(),d=()=>{var r;const l=document.createElement("div");l.innerHTML=`
        ...
        `;const m={margin:.5,filename:`contract-${e.contract_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};g(()=>import("./html2pdf-D3Qcp1wz.js").then(o=>o.h),__vite__mapDeps([0,1,2,3,4]),import.meta.url).then(o=>{o.default().set(m).from(l).save()})};return i.jsxs(f,{children:[i.jsx(b,{asChild:!0,children:i.jsx(x,{variant:s,size:a,onClick:d,children:i.jsx(y,{className:"h-4 w-4"})})}),i.jsx(h,{children:i.jsx("p",{children:t("Download PDF")})})]})}export{A as default};
