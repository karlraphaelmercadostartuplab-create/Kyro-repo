const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./html2pdf-C4tXZJ0w.js","./ui-2KAPYUOS.js","./app-R6O3DTjf.js","./app-CQG9E_-B.css","./app-Ul6bvw0I.css"])))=>i.map(i=>d[i]);
import{_ as g}from"./app-R6O3DTjf.js";import{j as i}from"./ui-2KAPYUOS.js";import{B as x}from"./button-Ct5rRE-A.js";import{a as f,b,c as h}from"./tooltip-4HSTLLoP.js";import{f as v,a as n,i as p}from"./helpers-Dk0R1Liu.js";import{u as _}from"./useTranslation-BKES0liM.js";import{D as y}from"./download-DB2MNUYX.js";/* empty css            */import"./index-C6CRyEGJ.js";import"./index-BMyiKApA.js";import"./utils-B-dksMZM.js";import"./utils-CmeZxMYV.js";import"./index-DfaEilmI.js";import"./createLucideIcon-BOLS3F80.js";function A({contract:e,variant:s="outline",size:a="sm"}){const{t}=_(),d=()=>{var r;const l=document.createElement("div");l.innerHTML=`
        ...
        `;const m={margin:.5,filename:`contract-${e.contract_number}.pdf`,image:{type:"jpeg",quality:.98},html2canvas:{scale:2},jsPDF:{unit:"in",format:"letter",orientation:"portrait"}};g(()=>import("./html2pdf-C4tXZJ0w.js").then(o=>o.h),__vite__mapDeps([0,1,2,3,4]),import.meta.url).then(o=>{o.default().set(m).from(l).save()})};return i.jsxs(f,{children:[i.jsx(b,{asChild:!0,children:i.jsx(x,{variant:s,size:a,onClick:d,children:i.jsx(y,{className:"h-4 w-4"})})}),i.jsx(h,{children:i.jsx("p",{children:t("Download PDF")})})]})}export{A as default};
