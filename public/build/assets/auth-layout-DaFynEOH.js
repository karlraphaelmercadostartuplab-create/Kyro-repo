<<<<<<<< HEAD:public/build/assets/auth-layout-BIWy859A.js
import{j as r}from"./ui-C3Q6Mp4i.js";import{X as n,x as c}from"./app-BQTzr2Vt.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-D3h_iVJL.js";import{k as p}from"./helpers-CC7SNAFX.js";import{A as h}from"./application-logo-xmsebiRw.js";import{C as u}from"./cookie-consent-Dw-hwJTt.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
========
import{j as r}from"./ui-CFOo-GGi.js";import{X as n,x as c}from"./app-C59Hkd1a.js";import{u as m,a as x,L as g,B as b}from"./use-favicon-20zxlOJF.js";import{k as p}from"./helpers-DlkUmdvS.js";import{A as h}from"./application-logo-CoXh6gAf.js";import{C as u}from"./cookie-consent-C47ofg3m.js";function j({children:t,title:s,description:o}){const{settings:a,getPrimaryColor:i}=m(),{adminAllSetting:d}=n().props;x();const l=a.themeMode==="dark"?a.logo_light||a.logo_dark:a.logo_dark||a.logo_light,e=i();return r.jsxs("div",{className:"min-h-screen bg-gray-50 relative overflow-hidden",children:[r.jsx("style",{children:`
>>>>>>>> origin/main:public/build/assets/auth-layout-DaFynEOH.js
                .bg-primary {
